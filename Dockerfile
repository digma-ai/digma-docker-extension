...
LABEL org.opencontainers.image.title="Digma Continuous Feedback" \
    ...
    com.docker.extension.changelog="<p>Extension changelog<ul><li>Jaeger traces view for insights</li><li>Backend version bump</li></ul></p>" \
