...
LABEL org.opencontainers.image.title="Digma Continuous Feedback" \
    ...
    com.docker.extension.changelog="<p>Extension changelog<ul><li>Bug fixes</li><li>Backend version bump to 0.2.179</li><li>Reduced number of containers</li><li>Improved memory consumption</li></ul></p>" \
